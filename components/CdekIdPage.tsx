       ...
       <div className="p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="space-y-4">
                <div className="w-12 h-12 bg-[#82C12D]/10 rounded-xl flex items-center justify-center text-[#82C12D]">
          ...
          <div className="bg-[#F9FAFB] rounded-xl p-6 md:p-8 text-center">
            ...
            <button 
                onClick={onConnect}
                className="px-8 py-4 bg-[#82C12D] text-white font-bold rounded-xl hover:bg-[#72a927] transition shadow-lg shadow-[#82C12D]/20 w-full md:w-auto"
            >
